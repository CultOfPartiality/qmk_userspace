...
const uint16_t PROGMEM combo_fold[]                  = {KC_U, KC_I, COMBO_END};
const uint16_t PROGMEM combo_unfold[]                = {KC_U, KC_O, COMBO_END};
...
combo_t key_combos[] = {
    ...
    COMBO_ACTION(combo_fold),
    COMBO_ACTION(combo_unfold),
